...
![Advanced Screen Ruler v5.0 в действии](https://github.com/hardway777/ScreenRuler/blob/main/images/screenshotv5.png)

## ✨ Возможности

-   **Измерение в перспективе**: Определите 4-точечную перспективную плоскость на изображении и измеряйте расстояния внутри нее так, как если бы вы работали на плоской поверхности. Инструмент использует надежный геометрический метод для предоставления точных, скорректированных с учетом перспективы измерений.
...
-   **Улучшения и исправления:**
    -   Исправлена инвертированная логика перетаскивания для захваченного холста; теперь перетаскивание по умолчанию двигает холст вместе с окном, а `Shift+Drag` перемещает окно над статичным холстом (режим "вьюпорта").
    -   Исправлена критическая ошибка, из-за которой повторные захваты экрана постепенно смещали существующие фигуры.
    -   Устранен неверный предпросмотр при рисовании перспективной плоскости, что сделало процесс более интуитивным.
    -   Устранена математическая ошибка, которая приводила к сбою вычислений перспективы на вертикальных или горизонтальных базовых линиях.
    -   Рамки меток фигур теперь корректно используют цвет самой фигуры для лучшей визуальной целостности.
    -   Исправлена ошибка, которая мешала регистрации кликов мыши для расстановки точек.
